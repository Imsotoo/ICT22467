...
🔗 [ดูสไลด์นำเสนอโปรเจกต์ (Canva)](https://canva.link/4o4uyfp303cv9ow) &nbsp;|&nbsp;
🎥 [วิดีโอตัวเต็ม (Full VDO)](https://www.youtube.com/watch?v=N-AGnE8ZrVk) &nbsp;|&nbsp;
📱 [วิดีโอสั้น (Short VDO)](https://www.tiktok.com/@warmhuggy/video/7631618096813395218?is_from_webapp=1&sender_device=pc))
...
| กิจกรรม | กฎการทำงาน |
|---------|------------|
| การเก็บข้อมูล | บันทึกจำนวนลูกกุ้ง (ตัว) และวันที่เริ่มเลี้ยง บันทึกแบบ manual |
| การวัดคุณภาพน้ำ | ข้อมูลเปลี่ยนตามเซนเซอร์ อุณหภูมิ, pH, ออกซิเจน, ระดับน้ำ |
| บันทึกการให้อาหาร | บันทึกปริมาณเป็นกิโลกรัม ต้องบันทึกแบบ manual |
| บันทึกการเจริญเติบโต | บันทึกน้ำหนักเฉลี่ย (กรัม) และความยาวเฉลี่ย (ซม.) ผู้ใช้เลือกวันที่สุ่มตรวจเองได้ |
